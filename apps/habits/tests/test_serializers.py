...
class TestHabitSerializer:
    ...
    def test_habit_with_reward_and_linked_habit(
        self, user_factory, habit_factory, place_factory
    ):
        user = user_factory()
        place = place_factory(owner=user)
    ...
    def test_habit_with_linked_non_pleasant_habit(
        self, user_factory, habit_factory, place_factory
    ):
        user = user_factory()
        place = place_factory(owner=user)
    ...
    def test_habit_serializer_read_only_fields(
        self, habit_factory, user_factory, place_factory
    ):
        user = user_factory()
        place = place_factory(owner=user)
